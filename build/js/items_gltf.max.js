$(document).ready(function() {
   ...
   /* {
        ...
        "name": "책장",
        "image": "models/thumbnails_new/bookcaseClosedWide.png",        //남겨놔야하는 것 책장
    ...
    // }, 
    {
        ...
        "name": "문틀",
        "image": "models/thumbnails_new/doorwayOpen.png",        //남겨놔야하는 문지방
        "model": "models/gltf/doorwayOpen.glb",
        "type": "7", // 3->7
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%AC%B8%ED%8B%80&frm=NVSHATC&prevQuery=%EB%AC%B8%EC%A7%80%EB%B0%A9",
    }, {
        "name": "드럼 세탁기",
        ...
        "type": "2",
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%93%9C%EB%9F%BC%20%EC%84%B8%ED%83%81%EA%B8%B0&frm=NVSHATC&prevQuery=%EC%84%B8%ED%83%81%EA%B8%B0",
    }, /*{
        "name": "Floorcorner",
    ...
    // }, 
    {
        ...
        "type": "7", // 3->7
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%AC%B8%ED%8B%80&frm=NVSHATC&prevQuery=%EB%9D%BC%EC%9A%B4%EB%93%9C%20%EC%83%A4%EC%9B%8C%20%EB%B6%80%EC%8A%A4",
    }, /* {
        ...
        "name": "오르내리창문2",
        "image": "models/thumbnails_new/wallWindowSlide.png",      //남겨놔야하는 오르내리창문
    ...
    }, 
    {
        ...
        "type": "2",
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%ED%99%94%EC%9E%A5%EC%8B%A4%20%EC%9C%A0%EB%A6%AC&frm=NVSHATC&prevQuery=%ED%99%94%EC%9E%A5%EC%8B%A4%EC%9C%A0%EB%A6%AC",
    }, /* {
        "name": "Bathroomsink",
    ...
    */
    {
        "name": "욕조1",
        "image": "models/thumbnails_new/bathtub.png",         //남겨놔야하는 욕조
        ...
        "name": "화장실 세면대",
        "image": "models/thumbnails/sink2.png",
        ...
        "name": "주방",
        "image": "models/thumbnails/window.png",
        "model": "models/gltf/kitchen.glb",                  //내가 추가한 것들 창문
        "type": "2", // 1->2
        "format": "gltf" ,
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%97%AC%EB%8B%AB%EC%9D%B4%EC%B0%BD&frm=NVSHATC&prevQuery=%EC%97%AC%EB%8B%AB%EC%9D%B4%20%EC%B0%BD"  
